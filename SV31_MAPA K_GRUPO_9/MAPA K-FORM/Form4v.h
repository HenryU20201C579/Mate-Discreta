...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Form4v::typeid));
			...
			this->groupBox1->Size = System::Drawing::Size(267, 562);
			...
			dataGridViewCellStyle3->SelectionBackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(128)),
				static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(128)));
			dataGridViewCellStyle3->SelectionForeColor = System::Drawing::SystemColors::Desktop;
			dataGridViewCellStyle3->WrapMode = System::Windows::Forms::DataGridViewTriState::False;
			this->dgvTablaV->DefaultCellStyle = dataGridViewCellStyle3;
			this->dgvTablaV->Location = System::Drawing::Point(5, 33);
			...
			this->dgvTablaV->Size = System::Drawing::Size(255, 514);
			...
			this->groupBox2->Location = System::Drawing::Point(380, 14);
			this->groupBox2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Padding = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox2->Size = System::Drawing::Size(333, 229);
			...
			this->label18->Location = System::Drawing::Point(240, 167);
			...
			this->label17->Location = System::Drawing::Point(175, 167);
			...
			this->label16->Location = System::Drawing::Point(108, 167);
			...
			this->label12->Location = System::Drawing::Point(301, 167);
			...
			this->btnMapaK->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			...
			this->dgvMapaK->DefaultCellStyle = dataGridViewCellStyle4;
			this->dgvMapaK->Location = System::Drawing::Point(5, 52);
			...
			this->dgvMapaK->Size = System::Drawing::Size(323, 171);
			...
			this->groupBox3->Location = System::Drawing::Point(316, 249);
			...
			this->groupBox3->Size = System::Drawing::Size(391, 327);
			...
			this->btnGrupo->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			...
			this->labelGrupo->Location = System::Drawing::Point(5, 42);
			this->labelGrupo->MinimumSize = System::Drawing::Size(380, 281);
			this->labelGrupo->Name = L"labelGrupo";
			this->labelGrupo->Padding = System::Windows::Forms::Padding(11, 10, 0, 0);
			this->labelGrupo->Size = System::Drawing::Size(380, 281);
			...
			this->groupBox4->Location = System::Drawing::Point(15, 628);
			...
			this->groupBox4->Size = System::Drawing::Size(699, 183);
			...
			this->btnSuma->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			...
			this->labelSuma->Location = System::Drawing::Point(12, 62);
			this->labelSuma->MinimumSize = System::Drawing::Size(680, 110);
			this->labelSuma->Name = L"labelSuma";
			this->labelSuma->Padding = System::Windows::Forms::Padding(11, 10, 0, 0);
			...
			this->pictureBox1->Location = System::Drawing::Point(0, -501);
			this->pictureBox1->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(761, 1463);
		...
		void Busqueda() {
			...
			int num = 1;
			if (bolsa16[0][0].getCf() == false && bolsa8[0][0].getCf() == false && bolsa4[0][0].getCf() == false && bolsa2[0][0].getCf() == false && bolsa1[0][0].getCf() == false)
				labelGrupo->Text = "0";
			else {
				for (int i = 0; i < 1; i++) {
					if (bolsa16[i][0].getN() > 0 && bolsa16[i][0].getN() < 17) {
						labelGrupo->Text = labelGrupo->Text + "Grupo " + num + ": " + bolsa16[i][0].getN() + ", " + bolsa16[i][1].getN() + ", " + bolsa16[i][2].getN() + ", " + bolsa16[i][3].getN() + ", " + bolsa16[i][4].getN() + ", " + bolsa16[i][5].getN() + ", " + bolsa16[i][6].getN() + ", " + bolsa16[i][7].getN() + ", " + bolsa16[i][8].getN() + ", " + bolsa16[i][9].getN() + ", " + bolsa16[i][10].getN() + ", " + bolsa16[i][11].getN() + ", " + bolsa16[i][12].getN() + ",\n " + bolsa16[i][13].getN() + ", " + bolsa16[i][14].getN() + " y " + bolsa16[i][15].getN() + "\n";
						num++;
					}
				}
				for (int i = 0; i < 7; i++) {
		...
		void Suma_productos() {
			if (bolsa16[0][0].getCf() == false && bolsa8[0][0].getCf() == false && bolsa4[0][0].getCf() == false && bolsa2[0][0].getCf() == false && bolsa1[0][0].getCf() == false)
				...
				if (bolsa8[0][0].getCf() == true) {
					...
					if (bolsa4[0][0].getCf() == true || bolsa2[0][0].getCf() == true || bolsa1[0][0].getCf() == true)
						labelSuma->Text = labelSuma->Text + " + ";
				}
				if (bolsa4[0][0].getCf() == true) {
					...
					if (bolsa2[0][0].getCf() == true || bolsa1[0][0].getCf() == true)
						labelSuma->Text = labelSuma->Text + " + ";
				}
